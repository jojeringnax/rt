    ...
    ymaps.ready( function() {
        ...
        var OrgLayout = ymaps.templateLayoutFactory.createClass(
            ...
            o_pm.events.add('click', function(o) {
                ...
                $.ajax({
                    url: "/web/?r=site/get-organization-statistic&organization_id=" + "<?= $organization->id ?>",
                    type: 'get',
            ...
            <?php
                ...
                a_pm.events.add('click', function(a) {
                    ...
                    $.ajax({
                        url: "/web/?r=site/get-autocolumn-statistic&autocolumn_id=" + "<?= $autocolumn->id ?>",
                        type: 'get',
                        success: function(res) {
                            let terminals = JSON.parse(res)['terminals'];
                            let data = JSON.parse(res)['statistic'];
                    ...
                    foreach ($spots[$autocolumnPrettyId] as $key2 => $spot) {
                        if ($key2 !== 'bounds' && $key2 !== 'cars' && $key2 !== 'carsStatuses' && $key2 !== 'carsTypes') {
                            ...
                            s_pm.events.add('click', function(s) {
                                ...
                                $.ajax({
                                    url: "/web/?r=site/get-spot-statistic&spot_id=" + "<?= $spot->id ?>",
                                    type: 'get',
                                    success: function(res) {
                                        let terminals = JSON.parse(res)['terminals'];
                                        let data = JSON.parse(res)['statistic'];
                                    ...
                                    success: function(data) {
                                        ...
                                        data.cars.forEach(function(el) {
                                          ...
                                          c_pm.events.add('click', function (c) {
                                              ...
                                              $.ajax({
                                                  url: "/web/?r=site/get-car-data&car_id=" + el.id,
                                                  type: 'get',
                                                  success: function(res) {
                                                  }
        ...
        button.click( function () {
            if(window.currentElement.hasOwnProperty('car')) {
                ...
                //AJAX -> SPOT
                $.ajax({
                    url: "/web/?r=site/get-spot-statistic&spot_id=" + idOfCurrentElement['spot'],
                    type: 'get',
                    success: function(res) {
                        let terminals = JSON.parse(res)['terminals'];
                        let data = JSON.parse(res)['statistic'];
            ...
            if(window.currentElement.hasOwnProperty('spot')) {
                ...
                $.ajax({
                    url: "/web/?r=site/get-autocolumn-statistic&autocolumn_id=" + idOfCurrentElement['autocolumn'],
                    type: 'get',
                    success: function(res) {
                        let terminals = JSON.parse(res)['terminals'];
                        let data = JSON.parse(res)['statistic'];
            ...
            if(window.currentElement.hasOwnProperty('autocolumn')) {
                ...
                $.ajax({
                    url: "/web/?r=site/get-organization-statistic&organization_id=" + idOfCurrentElement['organizations'],
                    type: 'get',
                    success: function(res) {
                        let terminals = JSON.parse(res)['terminals'];
                        let data = JSON.parse(res)['statistic'];
